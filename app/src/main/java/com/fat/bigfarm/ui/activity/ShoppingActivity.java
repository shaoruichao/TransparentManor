                ...
                if (code == 200){
                    ...
                    if (data.size()==0) {
                        ...
                        for (int i = 0; i < allInfo.getData().size(); i++) {
                            groups.add(new GroupInfo(i + "", allInfo.getData().get(i).getShopname(),"",""));
...
//                            Log.e(TAG, "onClick: "+group );
                ...
                intent.setClass(this,SuerOrderActivity.class);
