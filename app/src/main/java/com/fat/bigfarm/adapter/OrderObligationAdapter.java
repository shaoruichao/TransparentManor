...
public class OrderObligationAdapter extends BaseQuickAdapter<MyOrderAll.DataBean> {
    ...
    protected void convert(BaseViewHolder baseViewHolder, MyOrderAll.DataBean dataBean) {
        ...
        RelativeLayout rl_sure = baseViewHolder.getView(R.id.rl_sure);
...
//        final String orderid = dataBean.getOrderid();
        ...
        final Button bt_sure = baseViewHolder.getView(R.id.bt_sure);
        if (mOnItemClickLitener != null){
            ...
            bt_sure.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mOnItemClickLitener.sureonItemClick(bt_sure,adapterPosition);
                }
            });
    ...
    public interface OnItemClickListener{
        ...
        void sureonItemClick(Button bt_sure,int postion);
