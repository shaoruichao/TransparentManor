 ...
 * @author Yan Zhenjie.
 */
public class HttpResponseListeners<T> implements OnResponseListener<T> {
...
//    private WaitDialog mWaitDialog;
     ...
     */
    public HttpResponseListeners(Activity activity, Request<?> request, HttpListener<T> httpCallback, boolean canCancel, boolean isLoading) {
